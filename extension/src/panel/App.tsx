    ...
    <div className="app" style={{ display: "flex", flexDirection: "column", height: "100vh", background: darkMode ? "#1c1c1e" : "#fff", color: darkMode ? "#fff" : "#1c1c1e" }}>
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 12px", borderBottom: `1px solid ${darkMode ? "#444" : "#ddd"}` }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <span style={{ display: "flex", alignItems: "center", gap: "4px", fontSize: "0.75rem" }} title={editorStatus.detected ? `Editor detected: ${editorStatus.element} (${editorStatus.tier})` : "No editor detected"}>
            <span style={{ width: 8, height: 8, borderRadius: "50%", background: editorStatus.tier === "rich" ? "#27AE60" : editorStatus.tier === "plain" ? "#E67E22" : "#999", display: "inline-block" }} />
            {editorStatus.detected ? editorStatus.element : "No editor"}
          </span>
